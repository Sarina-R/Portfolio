  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div>
          <span className={`inline-block border-[3px] border-ink px-2 py-0.5 font-mono text-[11px] font-bold uppercase tracking-wide ${COLOR_CLASS[work.color]}`}>
            {work.slug}
          </span>
          <h3 className="mt-3 font-display text-2xl leading-[0.95] text-ink sm:text-[26px]">{work.title}</h3>
      ...
      <div className="relative mt-6 h-[220px] cursor-pointer select-none sm:h-[260px]" onClick={() => onOpen(work)}>
          ...
          return (
            <div
              ...
              style={{
                ...
                boxShadow: hover ? "6px 6px 0 rgba(20,17,15,0.9)" : "3px 3px 0 rgba(20,17,15,0.9)",
              }}
            >
